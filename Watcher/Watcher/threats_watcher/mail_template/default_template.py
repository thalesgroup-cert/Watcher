...
def get_template(words_occurrence, email_words):
    body = """\
        <html>
            <head>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style="text-align: center;" align="left" bgcolor="#ffffff">
                                    ...
                                    <p style="text-align: justify;">Please, find below trendy word(s) that match at least 
                                    <b>
        """
    body += str(
        words_occurrence) + """</b> times:</p> <p style="text-align: left; margin-left: 30px; margin-bottom: 25px;">"""
    body += "<br />".join(email_words) + "</p>" + """
